...
def Api_connect():
    Api_Id="AIzaSyChhMKO3CznRrrb9wjT8XS6Nwr426fR9Hc"
...
#get video ids
def get_videos_ids(channels_id):
    Video_Ids=[]
    response=youtube.channels().list(id=channels_id,
...
show_table=st.radio("Select Required Table",("Channels","Playlists","Videos","Comments"))
...
if question=="1. What are the names of all the videos and their corresponding channels?":
    ...
    mydb.commit()
    t7=cursor.fetchall()
    df7=pd.DataFrame(t7,columns=["channeltitle","totalview"])
    st.write(df7)
